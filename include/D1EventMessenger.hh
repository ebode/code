...
//
//
#ifndef D1EventMessenger_h
#define D1EventMessenger_h 1
...
class D1EventMessenger: public G4UImessenger
{
  public:

    D1EventMessenger(D1EventAction*);
    virtual ~D1EventMessenger();
 
    virtual void SetNewValue(G4UIcommand*, G4String);
 
  private:

    D1EventAction*        fD1Event;
    G4UIcmdWithAnInteger*  fSaveThresholdCmd;
    G4UIcmdWithAnInteger*  fVerboseCmd;
    G4UIcmdWithAnInteger*  fShape1ThresholdCmd;
     G4UIcmdWithAnInteger*  fShape2ThresholdCmd;
