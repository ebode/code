...
#ifndef D1UserTrackInformation_h
#define D1UserTrackInformation_h 1

enum D1TrackStatus { active=1, hitShape1=2, absorbed=4, boundaryAbsorbed=8,
                      hitShape2=16, inactive=14};
...
class D1UserTrackInformation : public G4VUserTrackInformation
{
  public:

    D1UserTrackInformation();
    virtual ~D1UserTrackInformation();
