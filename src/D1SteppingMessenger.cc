...
D1SteppingMessenger::D1SteppingMessenger(D1SteppingAction* step)
 : fStepping(step)
{
  fOneStepPrimariesCmd = new G4UIcmdWithABool("/D1/oneStepPrimaries",this);
...
D1SteppingMessenger::~D1SteppingMessenger(){
...
void 
D1SteppingMessenger::SetNewValue(G4UIcommand* command,G4String newValue){
