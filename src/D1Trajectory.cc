...
G4ThreadLocal G4Allocator<D1Trajectory>* D1TrajectoryAllocator = 0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

D1Trajectory::D1Trajectory()
  :G4Trajectory(),fShape1(false),fShape2(false),fDrawit(false),fForceNoDraw(false),fForceDraw(false)
{
...
D1Trajectory::D1Trajectory(const G4Track* aTrack)
  :G4Trajectory(aTrack),fShape1(false),fShape2(false),fDrawit(false)
{
...
D1Trajectory::D1Trajectory(D1Trajectory &right)
  :G4Trajectory(right),fShape1(right.fShape1),fShape2(right.fShape2),fDrawit(right.fDrawit)
{
...
void D1Trajectory::DrawTrajectory() const
{
  ...
  if (lineRequired) {
    ...
    if(fParticleDefinition==G4OpticalPhoton::OpticalPhotonDefinition()){
      if(fShape1) //WLS photons are red
