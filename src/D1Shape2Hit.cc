...
G4ThreadLocal G4Allocator<D1Shape2Hit>* D1Shape2HitAllocator=0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

D1Shape2Hit::D1Shape2Hit()
  : fShape2Number(-1),fPhotons(0),fPhysVol(0),fDrawit(false) {}
...
D1Shape2Hit::D1Shape2Hit(const D1Shape2Hit &right) : G4VHit()
{
  fShape2Number=right.fShape2Number;
...
const D1Shape2Hit& D1Shape2Hit::operator=(const D1Shape2Hit &right){
  fShape2Number = right.fShape2Number;
  fPhotons=right.fPhotons;
  fPhysVol=right.fPhysVol;
  fDrawit=right.fDrawit;
...
G4int D1Shape2Hit::operator==(const D1Shape2Hit &right) const{
  return (fShape2Number==right.fShape2Number);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void D1Shape2Hit::Draw(){
